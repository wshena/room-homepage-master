export const NavLink = ['home', 'shop', 'about', 'contact']

export const Slide = [
	{
		id:1,
		ImageDesktop: 'src/assets/desktop-image-hero-1.jpg',
		ImageMobile: 'src/assets/mobile-image-hero-1.jpg', 
	...
	{
		id:2,
		ImageDesktop: 'src/assets/desktop-image-hero-2.jpg', 
		ImageMobile: 'src/assets/mobile-image-hero-2.jpg', 
	...
	{
		id:3, 
		ImageDesktop: 'src/assets/desktop-image-hero-3.jpg', 
		ImageMobile: 'src/assets/mobile-image-hero-3.jpg', 
